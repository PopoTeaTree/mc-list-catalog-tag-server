...
@model({
  settings: {idInjection: false, mysql: {schema: 'tag', table: 'FeaturedTag_mcIDs'}}
})
export class FeaturedtagMcids extends Entity {
  @property({
    type: String,
    required: true,
    length: 25,
  ...
  constructor(data?: Partial<FeaturedtagMcids>) {
    super(data);
  }
}

export interface FeaturedtagMcidsRelations {
  // describe navigational properties here
}

export type FeaturedtagMcidsWithRelations = FeaturedtagMcids & FeaturedtagMcidsRelations;
